...
SKILL_ROOT = Path(__file__).resolve().parents[2] / "skills" / "dnanexus-integration-custom"
...
class SdkInspectionTests(unittest.TestCase):
    ...
    def test_version_comparison_is_numeric_not_lexicographic(self) -> None:
        ...
        self.assertEqual(parse("0.412.0"), (0, 412, 0))
        # The bug this guards: "0.99" > "0.412" as strings, but not as versions.
        self.assertLess(parse("0.99.0"), parse("0.412.0"))
        self.assertGreater(parse("1.0.0"), parse("0.412.0"))
    ...
    def test_version_comparison_tolerates_non_numeric_segments(self) -> None:
        ...
        self.assertIsInstance(inspect_dxpy.numeric_version("0.412.0rc1"), tuple)
